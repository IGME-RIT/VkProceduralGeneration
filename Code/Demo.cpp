...
void Demo::prepare_descriptor_pool()
{
	...
	// we will have seven uniform buffers in the entire program
	type_counts[0].type = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
	type_counts[0].descriptorCount = 7;

	// we will have eight image sampler in the entire program
	// 7 entities have just color textures
...
void Demo::prepare()
{
	...
	if (firstInit)
	{
		...
		delete logoTex->textureCPU;
		delete fontTex->textureCPU;
